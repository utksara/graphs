...
/*float aircraft::calculate_duration( int nodetype) {

	if (this->type == 1) {
		if (nodetype == 0) {
			minwaittime = input1[0];
		}
		if (nodetype == 1) {
			minwaittime = input1[1];
		}
		if (nodetype == 2) {
			minwaittime = input1[2];
		}
	...
	if (this->type == 2) {
		if (nodetype == 0) {
			minwaittime = input2[0];
		}
		if (nodetype == 1) {
			minwaittime = input2[1];
		}
		if (nodetype == 2) {
			minwaittime = input2[2];
		}
